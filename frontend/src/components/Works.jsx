  ...
  return (
    <div ref={cardRef}>
      ...
      >
        ...
        <div className="mt-5">
          <h3 
            className={`text-white font-bold text-[24px] ${live_demo_link ? 'cursor-pointer hover:text-blue-400 transition-colors' : ''}`}
            onClick={live_demo_link ? () => window.open(live_demo_link, "_blank") : undefined}
          >
            {name}
          </h3>
